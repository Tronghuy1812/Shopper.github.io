      ...
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="index.php">
            <img src="./public/backend/images/logo-blue.png" alt="" class="img-fuild">
          </a>
          <!-- <img src="https://vincom.com.vn/sites/default/files/2016-11/logo-nhasachphuongnam.com_.png" alt="logo"/> -->
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown mr-1">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="./public/backend/images/faces/face2.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="./public/backend/images/faces/face3.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name"><?=$_SESSION['user']['name'] ?? null ?></span>
            </a>
